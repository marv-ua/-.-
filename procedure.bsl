...
ЗначенияСвойств.Добавить("К21");
ЗначенияСвойств.Добавить("Х14");
	
Реквизит = Новый Структура ;
// Обязательные свойства реквизита
Реквизит.Вставить("Наименование", 			"ТипОрагнизации") ;
Реквизит.Вставить("ТипЗначения", 			Новый ОписаниеТипов("СправочникСсылка.ЗначенияСвойствОбъектов")) ; //Новый ОписаниеТипов("СправочникСсылка.Организации")) ; // Новый ОписаниеТипов("Строка")), Новый ОписаниеТипов("Булево")) ... 
Реквизит.Вставить("СправочникНаборДопРек", 	Справочники.НаборыДополнительныхРеквизитовИСведений.Справочник_Организации) ;
// НЕ обязательные свойства реквизита
Реквизит.Вставить("ЭтоДополнительноеСведение", 	Ложь) ;        
Реквизит.Вставить("Заголовок", 					"Тип организации") ;        
